...
<body
                ...
                <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%;" width="100%" cellpadding="0"
                  ...
                  <tr>
                    <td class="sm-px-24"
                      ...
                      <p style="font-weight: 600; font-size: 18px; margin-bottom: 10px;margin-top: 10px">Hey ${
                        user.firstName + '' + user.lastName
                      },</p>

                      <p style="margin: 0 0 24px;">
                        This is the password reset link you requested from REFHUB Team Support. Use to reset your REFHUB account password.
                      </p>
                      ...
                      <p style="margin: 0 0 16px;">
                        ...
                        <a href="mailto:cheesaknust@gmail.com" class="hover-underline"
                          style="--text-opacity: 1; color: #7367f0; text-decoration: none;">cheesaknust@gmail.com</a>.
                      </p>
                    </td>
                  </tr>
                  <tr>
  ...
  const text = `
        Reset Password, You recently requested to reset your password for your REFHUB account. Copy and paste it for reset password:
        ${resetUrl}
